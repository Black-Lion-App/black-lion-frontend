...
const LoginContainer = () => {
    return (
        <Box component="div" sx={{ display: 'flex', pb: { xs: 10, lg: 0 } }} className={classess.page}>
            <MainAppBar>
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={6} lg={6}>
                        <Box component="div" sx={{ display: 'flex', flexDirection: 'column', gap: { xs: 0, sm: 6, lg: 10 }, textAlign: { xs: 'center', sm: 'left' } }} className={classess.page__detailsContainer}>
                    ...
                    <Grid item xs={12} sm={6} lg={6}>
                        <Box component="div" className={classess.page__login_section}>
                            <Box component="div" sx={{ width: { xs: "100%", sm: "100%", lg: "90%" } }} className={classess.page__login_section__login_box}>
                                <LoginForm />
                            </Box>
